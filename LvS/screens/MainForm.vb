...
#Region "Properties"
 ...
 Public ReadOnly Property HelpFolder() As String
  Get
...
retry:
   If (.ShowDialog <> Windows.Forms.DialogResult.OK) Then Exit Sub
			If .LegalPath Then LoadActivity(.Path) Else If MessageBox.Show(My.Resources.STR_NOT_ACTIVITY_FOLDER, My.Resources.STR_ERROR, MessageBoxButtons.RetryCancel, MessageBoxIcon.Error, MessageBoxDefaultButton.Button1) = Windows.Forms.DialogResult.Retry Then GoTo retry
  End With
 End Sub
 ...
 Public Sub ShowHelp()
  ...
  Catch
			MessageBox.Show(My.Resources.STR_HELP_NOT_FOUND & ": " & helpFile, My.Resources.STR_ERROR, MessageBoxButtons.OK, MessageBoxIcon.Error)
  End Try
 End Sub
...
retry:
   If (.ShowDialog <> Windows.Forms.DialogResult.OK) Then Exit Sub
			If Not .LegalPath Then If MessageBox.Show(My.Resources.STR_PARENT_FOLDER_IS_ACTIVITY, My.Resources.STR_ERROR, MessageBoxButtons.RetryCancel, MessageBoxIcon.Error, MessageBoxDefaultButton.Button1) = Windows.Forms.DialogResult.Retry Then GoTo retry Else Exit Sub
   ...
   Catch
				MessageBox.Show(My.Resources.STR_UNPACK_FAILED & ": " + IO.Path.GetFileName(thePath), My.Resources.STR_ERROR, MessageBoxButtons.OK, MessageBoxIcon.Error)
   End Try
  End With
 End Sub
 ...
 Protected Sub ImportSubtitles(ByVal thePath As String, ByVal encoding As Encoding)
  My.Settings.SubtitlesFolder = IO.Path.GetDirectoryName(thePath)
  mruSubtitles.AddRecentlyUsedFile(thePath)
  Activity.ImportSubtitles(thePath, encoding)
 End Sub

 Protected Sub ImportDocument(ByVal thePath As String, ByVal encoding As Encoding)
  My.Settings.DocumentFolder = IO.Path.GetDirectoryName(thePath)
  mruDocument.AddRecentlyUsedFile(thePath)
  Activity.ImportDocument(thePath, encoding)
 End Sub
...
#Region "Export"
 ...
 Protected Sub ExportSubtitles(ByVal thePath As String, ByVal encoding As Encoding)
  My.Settings.SubtitlesFolder = IO.Path.GetDirectoryName(thePath)
  mruSubtitles.AddRecentlyUsedFile(thePath)
  Activity.ExportSubtitles(thePath, encoding)
 End Sub
...
retryActivityName:
  ...
  If ContainsChars(str, InvalidPathChars) OrElse ContainsChars(str, IO.Path.GetInvalidPathChars) Then 'also checking IO.Path.GetInvalidPathChars, but not printing those at the error message
			MessageBox.Show(My.Resources.STR_INVALID_FOLDER_NAME_CHARS & ": " & CharsString(InvalidPathChars))
...
retryParentFolder:
   If (.ShowDialog <> Windows.Forms.DialogResult.OK) Then Exit Sub
			If Not .LegalPath Then If MessageBox.Show(My.Resources.STR_PARENT_FOLDER_IS_ACTIVITY, My.Resources.STR_ERROR, MessageBoxButtons.RetryCancel, MessageBoxIcon.Error, MessageBoxDefaultButton.Button1) = Windows.Forms.DialogResult.Retry Then GoTo retryParentFolder Else Exit Sub
   My.Settings.ActivityParentFolder = .Path
   Dim activityPath As String = Path.Combine(.Path, str)
   If Directory.Exists(activityPath) Then
				If MessageBox.Show(My.Resources.STR_ACTIVITY_FOLDER_EXISTS & ": " & activityPath, My.Resources.STR_ERROR, MessageBoxButtons.RetryCancel, MessageBoxIcon.Error) = Windows.Forms.DialogResult.Retry Then GoTo retryActivityName
   Else
 ...
 Private Sub actionPortal_Execute(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles actionPortal.Execute
  ...
  Catch
   MessageBox.Show(My.Resources.STR_OPEN_URL_FAILED & ": " & My.Settings.PortalURL, My.Resources.STR_ERROR, MessageBoxButtons.OK, MessageBoxIcon.Error)
  End Try
 End Sub
 ...
 Private Sub actionSendFeedback_Execute(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles actionSendFeedback.Execute
  ...
  Catch
   MessageBox.Show(My.Resources.STR_OPEN_URL_FAILED & ": " & My.Settings.FeedbackURL & My.Resources.STR_ENTER_FEEDBACK, My.Resources.STR_ERROR, MessageBoxButtons.OK, MessageBoxIcon.Error)
  End Try
 End Sub
...
#Region "MRU"
 ...
 Private Sub mruActivity_MRUItemClicked(ByVal sender As System.Object, ByVal e As MostRecentlyUsedHandler.MRUItemClickedEventArgs) Handles mruActivity.MRUItemClicked
  ...
  Catch ex As DirectoryNotFoundException
			MessageBox.Show(ex.Message, My.Resources.STR_ERROR, MessageBoxButtons.OK, MessageBoxIcon.Error)
  End Try
 End Sub
