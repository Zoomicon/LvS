'Description: TextLinePairEditor class
...
Namespace LvS.objects.grid
	...
	Public Class TextLinePairEditor
		Inherits BaseCellEditor

#Region "Properties"

		Public Overloads ReadOnly Property Control() As TextLinePair
			Get
				Return CType(MyBase.Control, TextLinePair)
			End Get
		End Property
