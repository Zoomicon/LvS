Namespace LvS.objects.controllers
 ...
 Partial Class Controller
  ...
  Private Sub InitializeComponent()
      ...
      Me.ImgListSubtitles = New System.Windows.Forms.ImageList(Me.components)
      Me.cbFullScreen = New System.Windows.Forms.CheckBox()
      Me.ImgListFullScreen = New System.Windows.Forms.ImageList(Me.components)
      ...
      Me.cbSubtitlesOn.ImageList = Me.ImgListSubtitles
      ...
      'ImgListSubtitles
      '
      Me.ImgListSubtitles.ImageStream = CType(resources.GetObject("ImgListSubtitles.ImageStream"), System.Windows.Forms.ImageListStreamer)
      Me.ImgListSubtitles.TransparentColor = System.Drawing.Color.Transparent
      Me.ImgListSubtitles.Images.SetKeyName(0, "comments.png")
      Me.ImgListSubtitles.Images.SetKeyName(1, "no comments.png")
      '
      'cbFullScreen
      '
      resources.ApplyResources(Me.cbFullScreen, "cbFullScreen")
      Me.cbFullScreen.FlatAppearance.BorderSize = 0
      Me.cbFullScreen.FlatAppearance.CheckedBackColor = System.Drawing.Color.Transparent
      Me.cbFullScreen.ImageList = Me.ImgListFullScreen
      Me.cbFullScreen.Name = "cbFullScreen"
      Me.ToolTips.SetToolTip(Me.cbFullScreen, resources.GetString("cbFullScreen.ToolTip"))
      Me.cbFullScreen.UseVisualStyleBackColor = True
      '
      'ImgListFullScreen
      '
      Me.ImgListFullScreen.ImageStream = CType(resources.GetObject("ImgListFullScreen.ImageStream"), System.Windows.Forms.ImageListStreamer)
      Me.ImgListFullScreen.TransparentColor = System.Drawing.Color.Transparent
      Me.ImgListFullScreen.Images.SetKeyName(0, "FullScreenOn.png")
      Me.ImgListFullScreen.Images.SetKeyName(1, "FullScreenOff.png")
      '
      'sliderTime
      '
      resources.ApplyResources(Me.sliderTime, "sliderTime")
      Me.sliderTime.Duration = 0.0R
      Me.sliderTime.EndTime = 0.0R
      Me.sliderTime.Name = "sliderTime"
      Me.sliderTime.SelectionEndTime = 0.0R
      Me.sliderTime.SelectionStartTime = 0.0R
      Me.sliderTime.StartTime = 0.0R
      Me.sliderTime.Time = 0.0R
    ...
    Friend WithEvents ImgListSubtitles As System.Windows.Forms.ImageList
    ...
    Friend WithEvents ImgListFullScreen As System.Windows.Forms.ImageList
