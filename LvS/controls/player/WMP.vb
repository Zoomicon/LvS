...
#Region "Fields"
  ...
  Protected fPlaySelectionOnly As Boolean = False
  Protected fSelectionStartTime As Double = 0
  Protected fSelectionEndTime As Double = 0
...
#Region "Event handlers"
  ...
  Private Sub playerWMP_ErrorEvent(ByVal sender As Object, ByVal e As System.EventArgs) Handles playerWMP.ErrorEvent
   With playerWMP.Error
				MessageBox.Show(.Item(.errorCount - 1).errorDescription, My.Resources.STR_ERROR, MessageBoxButtons.OK, MessageBoxIcon.Error)
   End With
  End Sub
